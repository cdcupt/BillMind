...
| **F5** | Dedup repeated records within one multi-input session | friction / data-integrity | feature | sdd_pipeline (scoped) | ⏳ **open** — the remaining "improve" item (not a bug) | text #10 |
